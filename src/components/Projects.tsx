    ...
    <>
      <section id="projects" className="min-h-screen flex">
        <div className="m-auto">
          ...
          <hr className="my-5 w-3/5 lg:w-1/5 mx-auto" />
          <div className="grid grid-cols-1 xl:grid-cols-3 grid-rows-1 gap-6 m-5 lg:m-0">
            <div className="project-item">
              ...
              <h1 className="project-description">
                ...
                you can view the answer in a page where you can screenshoot it
                and upload it to social media stories.
              </h1>
            ...
            <div className="project-item">
              ...
              <h1 className="project-description">
                Confess and post it to instagram! or so called
                &quot;Menfess&quot; by the peeps. A website where you can submit
                your confession in a form, after that the admin will approve it
                first from &quot;behind the scene&quot; and it will show up as
                an instagram post!
              </h1>
            ...
            <div className="project-item">
              ...
              <h1 className="project-description">
                Rasa Tak Terbuang is an application for my school project in
                high school, the application is focused on selling leftover
                products that can still be consumed with lower price{" "}
                {"(only prototype)"}
              </h1>
              <div className="grid grid-cols-1 md:grid-cols-3 text-lg gap-4">
                <a
